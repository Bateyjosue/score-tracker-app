...
const initialTeams: Team[] = [
  { id: '1', name: 'Lightning Bolts', emoji: '⚡', score: 0, rank: 1, color: 'from-yellow-400 to-orange-500' },
  { id: '2', name: 'Brain Busters', emoji: '🧠', score: 0, rank: 1, color: 'from-purple-400 to-pink-500' },
  { id: '3', name: 'Quiz Masters', emoji: '🎯', score: 0, rank: 1, color: 'from-blue-400 to-cyan-500' },
  { id: '4', name: 'Trivia Titans', emoji: '🏆', score: 0, rank: 1, color: 'from-green-400 to-emerald-500' },
  { id: '5', name: 'Smart Cookies', emoji: '🍪', score: 0, rank: 1, color: 'from-amber-400 to-yellow-500' },
  { id: '6', name: 'Knowledge Knights', emoji: '⚔️', score: 0, rank: 1, color: 'from-indigo-400 to-purple-500' },
  { id: '7', name: 'Fact Finders', emoji: '🔍', score: 0, rank: 1, color: 'from-red-400 to-pink-500' },
];
...
export const useGameState = () => {
  ...
  const playSound = (type: 'success' | 'victory' | 'timeup') => {
    ...
    const frequencies = {
      ...
      victory: [261.63, 329.63, 392.00, 523.25], // C4, E4, G4, C5
  ...
  const getTopTeams = useCallback((count: number = 4) => {
